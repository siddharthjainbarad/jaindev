...
$('#1').attr('href','http://27162991.earntalktime.com').text("Earn Talktime (Best)");
...
$('#5').attr('href','http://richcashapp.com/richcrefer_table.php?ReferralId=J0UB18').text("RichCash (Very Good)");
